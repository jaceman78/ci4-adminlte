                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="userLevel" name="level">
                                    <option value="0">Assistente Operacional</option>
                                    <option value="1">Professor</option>
                                    <option value="2">Utilizador</option>
                                    <option value="3">Serviços Administrativos</option>
                                    <option value="4">Secretariado de Exames</option>
                                    <option value="5">Técnico</option>
                                    <option value="6">Direção</option>
                                    <option value="7">Técnico Sénior</option>
