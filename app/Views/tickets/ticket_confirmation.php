...
<html>
<head>
    <title>Confirmação de Criação de Ticket</title>
</head>
<body>
    <p>Olá, <strong><?= esc($user["name"]) ?></strong>,</p>
    <p>O seu ticket #<?= esc($ticket["id"]) ?> foi criado com sucesso com os seguintes detalhes:</p>
    <ul>
        ...
        <li><strong>Criado em:</strong> <?= esc($ticket["created_at"]) ?></li>
    </ul>
