                    ...
                    <div class="card-body">
                        ...
                        <?php else: ?>
                            <div class="table-responsive">
                                <table id="tabelaCreditosDisponiveis" class="table table-bordered table-striped table-hover nowrap" style="width:100%">
                                    <thead>
                                        <tr>
                                            <?php if ($userLevel >= 6): ?>
                                            <th>Professor</th>
            ...
            <div class="col-12">
                <div class="card card-secondary collapsed-card">
                    ...
                    <div class="card-body">
                        ...
                        <?php else: ?>
                            <div class="table-responsive">
                                <table id="tabelaCreditosUsados" class="table table-bordered table-sm nowrap" style="width:100%">
                                    <thead>
                                        <tr>
                                            <?php if ($userLevel >= 6): ?>
                                            <th>Professor</th>
