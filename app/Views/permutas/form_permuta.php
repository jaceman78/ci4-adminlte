                ...
                if (response.success && response.blocos) {
                    ...
                    if (response.blocos.length > 0) {
                        $.each(response.blocos, function(index, bloco) {
                            var label = '';
                            if (bloco.designacao && bloco.hora_inicio && bloco.hora_fim) {
                                label = bloco.designacao + ' (' + bloco.hora_inicio.substring(0,5) + ' - ' + bloco.hora_fim.substring(0,5) + ')';
                            } else if (bloco.designacao) {
                                label = bloco.designacao;
                            } else {
                                label = bloco.hora_inicio.substring(0,5) + ' - ' + bloco.hora_fim.substring(0,5);
                            }
