    ...
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php else: ?>
                    <table id="tabelaPermutasFuturas" class="table table-bordered table-striped table-hover nowrap" style="width:100%">
                        <thead>
                            <tr>
                                <th>Data Aula</th>
                                <th>Disciplina</th>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php else: ?>
                    <table id="tabelaPermutasPassadas" class="table table-bordered table-striped table-hover nowrap" style="width:100%">
                        <thead>
                            <tr>
                                <th>Data Aula</th>
                                <th>Disciplina</th>
