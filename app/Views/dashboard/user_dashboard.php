                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <!-- Permutas Futuras (para utilizadores com NIF e nível 1-3) -->
                            <?php if (!empty($permutas_futuras)): ?>
                            <div class="row mt-4">
                                <div class="col-12">
...
// Dashboard para utilizadores níveis 0-4
// ========================================

$(document).ready(function() {
    // Prevenção de erros: Verificar se existe algum elemento canvas que possa causar erro
    // Este dashboard não usa gráficos, mas pode haver scripts globais que tentam inicializá-los
