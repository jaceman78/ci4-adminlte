                                    ...
                                    <div class="card mb-2 shadow-sm">
                                        <div class="card-body p-3">
                                            <div class="d-flex justify-content-between align-items-start mb-2">
                                                <div>
                                                    <h6 class="mb-0">
                                                        <strong><?= esc($permuta['disciplina_abrev']) ?></strong>
                                                    </h6>
                                                    <small class="text-muted"><?= esc($permuta['turma_nome']) ?></small>
                                                </div>
                                            ...
                                            <div class="row g-2 mt-2">
                                                <div class="col-6">
                                                    <small class="text-muted d-block"><i class="fas fa-calendar"></i> Data Original</small>
                                                    <strong><?= date('d/m/Y', strtotime($permuta['data_aula_original'])) ?></strong>
                                                </div>
                                                <div class="col-6">
                                                    <small class="text-muted d-block"><i class="fas fa-calendar-check"></i> Reposição</small>
                                                    <strong><?= date('d/m/Y', strtotime($permuta['data_aula_permutada'])) ?></strong>
                                                </div>
                                            </div>
            ...
            <div class="row mt-4">
                <div class="col-12">
                    ...
                    <div class="card card-secondary mt-3">
                        <div class="card-header d-flex justify-content-between align-items-center" style="cursor: pointer;" data-bs-toggle="collapse" data-bs-target="#historicoConvocatoriasTec" aria-expanded="false" aria-controls="historicoConvocatoriasTec">
                        ...
                        <div class="collapse" id="historicoConvocatoriasTec">
                            <div class="card-body p-0">
