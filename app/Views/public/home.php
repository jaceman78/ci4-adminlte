                ...
                <div class="card feature-card shadow-sm h-100 position-relative">
                    ...
                    <?php 
                        ...
                        if (strpos($currentHost, 'localhost') !== false || strpos($currentHost, '127.0.0.1') !== false) {
                            $kitDigitalUrl = 'http://localhost:8080/public/kit-digital';
                        } else {
                            $kitDigitalUrl = 'https://public.escoladigital.cloud/kit-digital';
                        }
                    ?>
            ...
            <div class="col-md-4">
                <div class="card feature-card shadow-sm h-100 position-relative">
                    ...
                    <?php 
                        ...
                        // Verificar se estamos em localhost
                        if (strpos($currentHost, 'localhost') !== false || strpos($currentHost, '127.0.0.1') !== false) {
                            $reportarAvariaUrl = 'http://localhost:8080/public/reportar-avaria-kit';
                        } else {
                            $reportarAvariaUrl = 'https://public.escoladigital.cloud/reportar-avaria-kit';
                        }
                    ?>
                    <a href="<?= $reportarAvariaUrl ?>" class="stretched-link text-decoration-none text-reset">
                        <div class="card-body text-center p-4">
                            <div class="icon-box mx-auto"><i class="bi bi-exclamation-triangle"></i></div>
                            <h5 class="fw-bold mb-3">Reportar Avaria</h5>
                            <p class="text-muted">Reportar avaria do meu Kit Digital. Serviço online de sinalização.</p>
                        </div>
                    </a>
                </div>
            </div>
